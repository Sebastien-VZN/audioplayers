...
<p align="center">
  <img src="https://img.shields.io/badge/Version-6.6.5-blueviolet?style=flat-square&logo=github" alt="Version"/>
  <img src="https://img.shields.io/badge/Release%20Date-2026--06--17-blue?style=flat-square&logo=calendar" alt="Release Date"/>
</p>
...
- **Standard & Strict Linting:** Full migration from `flame_lint` to official **`flutter_lints` and `very_good_analysis`**. This ensures the codebase follows industrial Flutter best practices without superfluous custom dependencies.
